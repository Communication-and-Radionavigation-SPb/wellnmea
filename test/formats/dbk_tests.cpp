...
#include <wellnmea/formats/dbk.hpp>
...
TEST(DBK_constructor, can_be_instantiated) {
  EXPECT_NO_THROW({ DBK(); });
}

#define Suite DBK_Tests

class DBK_Tests : public ::testing::TestWithParam<json> {
 public:
  DBK format;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    [](const ::testing::TestParamInfo<DBK_Tests::ParamType>& info) {
      std::stringstream ss;
      ss << "DBK_" << info.index;
